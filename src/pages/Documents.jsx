...
function Documents() {
  ...
  const documents = [
    { name: 'Building Regulations', uploaded: '2023-08-01', type: 'PDF', status: 'Available' },
    { name: 'Meeting Minutes', uploaded: '2023-07-15', type: 'DOCX', status: 'Available' },
    { name: 'Maintenance Report', uploaded: '2023-06-10', type: 'PDF', status: 'Archived' },
  ];
        ...
        <div className="gap-1 px-6 flex flex-1 justify-center py-5">
          ...
          <div className="layout-content-container flex flex-col max-w-[960px] flex-1">
            <div className="flex flex-wrap justify-between gap-3 p-4">
              <p className="text-[#0e141b] tracking-light text-[32px] font-bold leading-tight min-w-72">Documents</p>
            </div>
                ...
                <table className="flex-1">
                  <thead>
                    <tr className="bg-slate-50">
                      ...
                      <th className="px-4 py-3 text-left text-[#0e141b] w-[400px] text-sm font-medium leading-normal">Uploaded</th>
                      <th className="px-4 py-3 text-left text-[#0e141b] w-[400px] text-sm font-medium leading-normal">Type</th>
                  ...
                  <tbody>
                    {documents.map((d, i) => (
                      <tr key={i} className="border-t border-t-[#d0dbe7]">
                        <td className="h-[72px] px-4 py-2 w-[400px] text-[#4e7097] text-sm font-normal leading-normal">{d.name}</td>
                        <td className="h-[72px] px-4 py-2 w-[400px] text-[#4e7097] text-sm font-normal leading-normal">{d.uploaded}</td>
                        <td className="h-[72px] px-4 py-2 w-[400px] text-[#4e7097] text-sm font-normal leading-normal">{d.type}</td>
